<?php
  ...
  if (isset($_POST["ingresar"])) {
    ...
    if (!empty($email) && $email != "" && !empty($pass) && $pass != "") {
      $query = "SELECT id, email, nombre, telefono, password, es_admin FROM USUARIOS 
...
<html lang="es">
  ...
  <div class="login-logo">
    <img src="dist/img/logo3.png" class="img-fluid" width="200">
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-sm-12">
            <button type="submit" name="ingresar" class="btn btn-primary d-block w-100">
